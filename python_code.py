...
def search():
    ...
    url = 'https://github.com/' + str(username)
    browser.get(url)
    ...
    projects = browser.find_element_by_xpath('//*[@id="js-pjax-container"]/div/div[2]/div[2]/nav/a[3]/span')
    print("Number of Projects : ",end=" ")
    print(projects[0].text)
    
    stars = browser.find_element_by_xpath('//*[@id="js-pjax-container"]/div/div[2]/div[2]/nav/a[4]/span')
    print("Stars : ",end=' ')
    print(stars[0].text)
    
    followers = browser.find_element_by_xpath('//*[@id="js-pjax-container"]')
    print("Followers : ",end=" ")
    print(followers[0].text)
    
    following = browser.find_element_by_xpath('//*[@id="js-pjax-container"]/div/div[2]/div[2]/nav/a[6]/span')
    print("Following : ",end= " ")
